      ...
      <div className='container pt-14'>
         <div className='md:flex items-center justify-between sm:flex-col md:flex-row'>
           <div className='w-full md:basis-1/2'>
             ...
             <h1 data-aos="fade-up" data-aos-duration="1500" className='text-headingColor font-[800] text-[1.8rem] sm:text-[40px] leading-[35px] sm:leading-[46px] mt-5'>I'm Tumelo Khanye <br/>Software Developer</h1>
             ...
             <p data-aos="fade-left" data-aos-duration="1500" className='flex  gap-2 text-headingColor mt-14 font-[500] text-[15px] leading-7 sm:pl-14 sm:pr-10' >
              ...
              <div className='flex items-center gap-9 mt-14'>
                ...
                <span>
                  <a className='text-smallTextColor text-[16px] font-[600]' href=""><BsFacebook /></a>
                </span>
                <span>
                  <a className='text-smallTextColor text-[16px] font-[600]' href=""><BsGithub/></a>
                </span>
                <span>
                  <a className='text-smallTextColor text-[16px] font-[600]' href=""><BsTwitterX/></a>
                </span>
                <span>
                  <a className='text-smallTextColor text-[16px] font-[600]' href=""><BsLinkedin/></a>
                </span>
                <span>
                  <a className='text-smallTextColor text-[16px] font-[600]' href=""><BsInstagram/></a>
                </span>
              </div>
           </div>
           ...
           <div className='md:basis-1/2 flex justify-between text-center mt-10 flex-wrap gap-3 md:mt-0 md:flex-col md:justify-end md:text-end'>
            ...
            <div className='md-10'>
              ...
              <h4 className='text-headingColor font-[600] text-[16px]'>Years of Experience</h4>
            </div>
            <div className='md-10'>
              <h2 className='text-headingColor font-[700] text-[32px]'>
                <CountUp start={0} end={20} duration={2} suffix='+'/>
              </h2>
              <h4 className='text-headingColor font-[600] text-[16px]'>Projects Completed</h4>
            </div>
            <div className='md-10'>
              <h2 className='text-headingColor font-[700] text-[32px]'>
                <CountUp start={0} end={97} duration={2} suffix='%'/>
              </h2>
              <h4 className='text-headingColor font-[600] text-[16px]'>Success Rate</h4>
            </div>
